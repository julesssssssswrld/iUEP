...
const ICONS = {
    ...
    login: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" class="theme-icon"><path d="M480-120v-80h280v-560H480v-80h280q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H480Zm-80-160-55-58 102-102H120v-80h327L345-622l55-58 200 200-200 200Z"/></svg>`,
    signup: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" class="theme-icon"><path d="M720-400v-120H600v-80h120v-120h80v120h120v80H800v120h-80Zm-360-80q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Z"/></svg>`,
};
        ...
        <div id="header-right">
            ...
            <button id="user-preview-trigger" popovertarget="user-options-popup">
                <div id="user-preview">
                    ...
                    <div class="user-preview-text">
                        <h2>Hello, <span class="display-username">UEPian</span>!</h2>
                        <p class="sub-text display-stu-id"></p>
                    </div>
                    ${ICONS.chevron}
                </div>
            </button>
            ...
            <div class="content-box" id="user-options-popup" popover>
                ...
                <div id="popup-bottom-section">
                    ...
                    <a href="login.html" id="popup-login-link" style="display:none;">
                        <div class="popup-options">
                            ${ICONS.login}
                            <p class="main-text">Log In</p>
                        </div>
                    </a>
                    <a href="signup.html" id="popup-signup-link" style="display:none;">
                        <div class="popup-options">
                            ${ICONS.signup}
                            <p class="main-text">Create an Account</p>
                        </div>
                    </a>
                </div>
            </div>
...
function updateUserInfo() {
    ...
    // Hide student ID line when guest
    document.querySelectorAll('.display-stu-id').forEach((el) => {
        el.style.display = isGuest ? 'none' : '';
    });

    // Swap popover options based on auth state
    const settingsLink = document.getElementById('popup-settings-link');
    const logoutLink = document.getElementById('logout-link');
    const loginLink = document.getElementById('popup-login-link');
    const signupLink = document.getElementById('popup-signup-link');

    if (settingsLink) settingsLink.style.display = isGuest ? 'none' : '';
    if (logoutLink) logoutLink.style.display = isGuest ? 'none' : '';
    if (loginLink) loginLink.style.display = isGuest ? '' : 'none';
    if (signupLink) signupLink.style.display = isGuest ? '' : 'none';
